...
public class PIRBindService {

    private static final String TAG = "NoohuTesting";
    private static final String SERVICE_NAME = "vendor.zumi.pircontrol.IPIRService/default";

    public static IPIRService getBind() {
        try {
            ...
            Log.d(TAG, "Local AIDL descriptor: " + IPIRService.Stub.DESCRIPTOR);

            // Bind to the remote service
            return IPIRService.Stub.asInterface(binder);

        } catch (Exception e) {
            Log.e(TAG, "Error accessing IPIRService: " + e.getMessage(), e);
            return null;
        }
    }
}
