...
public class LEDBindService {

    private static final String TAG = "NoohuTesting";
    private static final String SERVICE_NAME = "vendor.zumi.ledcontrol.ILEDService/default";

    public static ILEDService getBind() {
        try {
            ...
            Log.d(TAG, "Local AIDL descriptor: " + ILEDService.Stub.DESCRIPTOR);

            // Bind to the remote service
            return ILEDService.Stub.asInterface(binder);

        } catch (Exception e) {
            Log.e(TAG, "Error accessing ILEDService: " + e.getMessage(), e);
            return null;
        }
    }
}
